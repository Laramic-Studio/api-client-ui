      ...
      {variables.map((v, i) => (
        ...
        >
          ...
          <button
            ...
            className={cn(
              "h-8 w-8 grid place-items-center rounded transition-colors disabled:opacity-50",
              v.secret
          ...
          <button
            ...
            disabled={readOnly}
            onClick={() => onRemove(i)}
            className="h-8 w-8 grid place-items-center rounded text-muted-foreground hover:text-[hsl(var(--danger))] hover:bg-accent/50 disabled:opacity-50"

    ...
    return (
      <div className="min-h-screen w-full bg-background text-foreground grid place-items-center p-6">
        <div className="text-center max-w-md">
          <div className="text-[11px] uppercase tracking-[0.18em] text-muted-foreground font-geom">// 404</div>
  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground flex flex-col">
      <header className="h-12 border-b border-[hsl(var(--border))] flex items-center px-4 gap-3">
        ...
        <div className="text-[13.5px] font-medium tracking-tight">{collection.name} <span className="text-muted-foreground font-geom text-[11px] uppercase tracking-wider ml-2">/ public docs</span></div>
      ...
      <div className="flex-1 grid grid-cols-[260px_1fr]">
        <aside className="border-r border-[hsl(var(--border))] overflow-y-auto p-2">
          <div className="px-2 py-2 text-[10px] uppercase tracking-wider text-muted-foreground font-geom">Endpoints</div>
        ...
        <main className="overflow-auto p-8">
          <div className="max-w-3xl">
            <div className="text-[11px] uppercase tracking-[0.18em] text-muted-foreground font-geom">// reference</div>
            ...
            <div className="mt-6 rounded-md border border-[hsl(var(--border))] bg-card p-5">
              <div className="text-[11px] uppercase tracking-wider text-muted-foreground font-geom inline-flex items-center gap-2">
                <KeyRound className="h-3.5 w-3.5" /> Authentication
              </div>
              <p className="mt-2 text-[13px]">
                All endpoints require a bearer token: <span className="font-geom text-[hsl(var(--brand))]">Authorization: Bearer [[TOKEN]]</span>.
              </p>
            </div>
              ...
              <div className="mt-6 space-y-6">
                <div>
                  <div className="flex items-center gap-3">
                    ...
                    <code className="font-geom text-[14px]">{activeReq.url}</code>
                    <button
